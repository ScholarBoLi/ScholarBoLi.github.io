...
## 📚 Journal Papers
/*
- <span style="background-color:blue; color:white; font-family: 'Special Elite', cursive;">JEIT 2025</span> **Yu Qian**, Zeyu Yang, Ranran Wang, Jiahao Cai, Chao Li, Qingrong Huang, Lingyan Fan, Yunlong Li, Cheng zhuo and Xunzhao Yin, "FerroeFerroelectric FET-based Compute-in-Memory Solver for Combinatorial Optimization Problems". Journal of Electronics & Information Technology.
...
- <span style="background-color:blue; color:white; font-family: 'Special Elite', cursive;">Nature Communications 2024</span> Xunzhao Yin\*, **Yu Qian**\*, Alptekin Vardar, Marcel Günther, Franz Müller, Nellie Laleni, Zijian Zhao, Zhouhang Jiang, Zhiguo Shi, Yiyu Shi, Xiao Gong, Cheng Zhuo, Thomas Kämpfe and Kai Ni, "Ferroelectric Compute-in-Memory Annealer for Combinatorial Optimization Problems". Nature Communications 15, 2419 (2024). (IF = 15.7, SCI Section I, <span style="color:red; font-weight:bold;">Editor’s Highlights</span>)
